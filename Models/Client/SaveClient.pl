...
buscarClientePorId(Ident, [client(Ident, Name, Age, Cpf, Email, Password, Cash, Patrimony, CanDeposit, Row, Col, AllAssets)|_], client(Ident, Name, Age, Cpf, Email, Password, Cash, Patrimony, CanDeposit, Row, Col, AllAssets)).
buscarClientePorId(Ident, [_|Resto], ClienteEncontrado) :-
    buscarClientePorId(Ident, Resto, ClienteEncontrado).
